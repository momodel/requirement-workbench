...
# backend/app/config.py
        return cls(
            ...
            llm_stream_timeout_seconds=float(os.getenv("LLM_STREAM_TIMEOUT_SECONDS") or os.getenv("CLAUDE_STREAM_TIMEOUT_SECONDS") or "90"),
            llm_structured_timeout_seconds=float(os.getenv("LLM_STRUCTURED_TIMEOUT_SECONDS") or os.getenv("CLAUDE_STRUCTURED_TIMEOUT_SECONDS") or "45"),
            llm_artifact_timeout_seconds=float(os.getenv("LLM_ARTIFACT_TIMEOUT_SECONDS") or os.getenv("CLAUDE_ARTIFACT_TIMEOUT_SECONDS") or "180"),
